import { blue, bold, cyan, dim, green, red, stripColor, yellow } from "https://deno.land/std@0.145.0/fmt/colors.ts";
...
export { blue, bold, cyan, dim, green, red, stripColor, yellow };
