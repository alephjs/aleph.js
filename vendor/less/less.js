...
export default (function () {
  ...
  function addDataAttr(options, tag) {
    for (var opt in tag.dataset) {
      if (tag.dataset.hasOwnProperty(opt)) {
        if (
          opt === "env" || opt === "dumpLineNumbers" || opt === "rootpath" ||
          opt === "errorReporting"
        ) {
  ...
  var browser = {
    createCSS: function (document, styles, sheet) {
      ...
      if (!styleNode.styleSheet) {
        ...
        keepOldStyleNode =
          (oldStyleNode !== null && oldStyleNode.childNodes.length > 0 &&
  ...
  var Color = /** @class */ (function (_super) {
    ...
    Color.prototype.toCSS = function (context, doNotCompress) {
      ...
      if (compress) {
        ...
        if (
          splitcolor[1] === splitcolor[2] && splitcolor[3] === splitcolor[4] &&
  ...
  var Selector = /** @class */ (function (_super) {
    ...
    Selector.prototype.createDerived = function (
      ...
      newSelector.evaldCondition = (evaldCondition != null)
        ? evaldCondition
        : this.evaldCondition;
  ...
  var Anonymous = /** @class */ (function (_super) {
    ...
    function Anonymous(
      ...
      _this.rulesetLike = (typeof rulesetLike === "undefined")
        ? false
        : rulesetLike;
  ...
  var Declaration = /** @class */ (function (_super) {
    ...
    function Declaration(
      ...
      var _this = _super.call(this) || this;
      _this.name = name;
      _this.value = (value instanceof Node)
        ? value
      ...
      _this.variable = (variable !== undefined)
        ? variable
  ...
  contexts.Eval = /** @class */ (function () {
    ...
    Eval.prototype.pathRequiresRewrite = function (path) {
      var isRelative = this.rewriteUrls === RewriteUrls.LOCAL
        ? isPathLocalRelative
        : isPathRelative;
  ...
  var Ruleset = /** @class */ (function (_super) {
    ...
    Ruleset.prototype.eval = function (context) {
      ...
      for (i = 0; (rule = rsRules[i]); i++) {
        ...
        if (
          rule instanceof Ruleset && rule.selectors &&
    ...
    function AtRule(
      ...
      if (rules) {
        if (Array.isArray(rules)) {
          ...
          _this.rules = [rules];
          _this.rules[0].selectors =
            (new Selector([], null, null, index, currentFileInfo))
  ...
  var Dimension = /** @class */ (function (_super) {
    ...
    function Dimension(value, unit) {
      ...
      _this.unit = (unit && unit instanceof Unit)
        ? unit
    ...
    Dimension.prototype.operate = function (context, op, other) {
      ...
      if (op === "+" || op === "-") {
        if (unit.numerator.length === 0 && unit.denominator.length === 0) {
          ...
          other.unit.numerator.length === 0 && unit.denominator.length === 0
        );
        else {
          other = other.convertTo(this.unit.usedUnits());
          if (
            context.strictUnits && other.unit.toString() !== unit.toString()
          ) {
            throw new Error(
              "Incompatible units. Change the units or use the unit function. " +
                ("Bad units: '" + unit.toString() + "' and '" +
                  other.unit.toString() + "'."),
            );
          }
        ...
        unit.denominator = unit.denominator.concat(other.unit.denominator)
          .sort();
        unit.cancel();
      } else if (op === "/") {
  ...
  var Expression = /** @class */ (function (_super) {
    ...
    Expression.prototype.eval = function (context) {
      ...
      if (this.value.length > 1) {
        ...
        if (
          this.value[0].parens && !this.value[0].parensInOp && !context.inCalc
        ) {
          doubleParen = true;
        }
      ...
      if (
        this.parens && this.parensInOp && !mathOn && !doubleParen &&
  ...
  var Media = /** @class */ (function (_super) {
    ...
    function Media(value, features, index, currentFileInfo, visibilityInfo) {
      ...
      _this._fileInfo = currentFileInfo;
      var selectors =
        (new Selector([], null, null, _this._index, _this._fileInfo))
          .createEmptySelectors();
    ...
    Media.prototype.eval = function (context) {
      ...
      this.rules[0].functionRegistry = context.frames[0].functionRegistry
        .inherit();
    ...
    Media.prototype.evalTop = function (context) {
      ...
      if (context.mediaBlocks.length > 1) {
        var selectors =
          (new Selector([], null, null, this.getIndex(), this.fileInfo()))
            .createEmptySelectors();
  ...
  var JsEvalNode = /** @class */ (function (_super) {
    ...
    JsEvalNode.prototype.evaluateJavaScript = function (expression, context) {
      ...
      try {
        ...
        throw {
          message: "JavaScript evaluation error: " + e.message + " from `" +
            expression + "`",
          filename: this.fileInfo().filename,
          index: this.getIndex(),
        };
      ...
      try {
        ...
        throw {
          message: "JavaScript evaluation error: '" + e.name + ": " +
            e.message.replace(/["]/g, "'") + "'",
          filename: this.fileInfo().filename,
          index: this.getIndex(),
        };
  ...
  var Definition = /** @class */ (function (_super) {
    ...
    Definition.prototype.evalParams = function (
      ...
      var argsLength = 0;
      if (
        mixinEnv.frames && mixinEnv.frames[0] &&
  ...
  var environment = /** @class */ (function () {
    ...
    environment.prototype.getFileManager = function (
      ...
      if (options.pluginManager) {
        fileManagers = [].concat(fileManagers).concat(
          options.pluginManager.getFileManagers(),
        );
      }
  ...
  var AbstractPluginLoader = /** @class */ (function () {
    ...
    AbstractPluginLoader.prototype.evalPlugin = function (
      ...
      var shortname =
        (new this.less.FileManager()).extractUrlParts(filename).filename;
      if (filename) {
    ...
    AbstractPluginLoader.prototype.trySetOptions = function (
      ...
      if (options && !plugin.setOptions) {
        return new LessError({
          message: "Options have been provided but the plugin " + name +
  ...
  ImportVisitor.prototype = {
    ...
    onImported: function (
      ...
      var duplicateImport = importedAtRoot ||
  ...
  var ProcessExtendsVisitor = /** @class */ (function () {
    ...
    ProcessExtendsVisitor.prototype.isElementValuesEqual = function (
      ...
      if (
        typeof elementValue1 === "string" || typeof elementValue2 === "string"
      ) {
    ...
    ProcessExtendsVisitor.prototype.extendSelector = function (
      ...
      for (matchIndex = 0; matchIndex < matches.length; matchIndex++) {
        ...
        if (currentSelectorPathIndex === match.pathIndex && matchIndex > 0) {
          path[path.length - 1].elements = path[path.length - 1].elements
            .concat(newElements);
        } else {
          path = path.concat(
  ...
  var CSSVisitorUtils = /** @class */ (function () {
    ...
    CSSVisitorUtils.prototype.containsSilentNonBlockedChild = function (
      ...
      for (var r = 0; r < bodyRules.length; r++) {
        rule = bodyRules[r];
        if (
          rule.isSilent && rule.isSilent(this._context) &&
  ...
  ToCSSVisitor.prototype = {
    ...
    visitComment: function (commentNode, visitArgs) {
      if (
        commentNode.blocksVisibility() || commentNode.isSilent(this._context)
      ) {
        return;
      }
      return commentNode;
    ...
    checkValidNodes: function (rules, isRoot) {
      ...
      for (var i = 0; i < rules.length; i++) {
        ...
        if (
          isRoot && ruleNode instanceof tree.Declaration && !ruleNode.variable
        ) {
          throw {
            message:
  ...
  var getParserInput = (function () {
    ...
    function skipWhitespace(length) {
      ...
      for (; parserInput.i < endIndex; parserInput.i++) {
        ...
        if (
          (c !== CHARCODE_SPACE) && (c !== CHARCODE_LF) &&
          (c !== CHARCODE_TAB) && (c !== CHARCODE_CR)
        ) {
          break;
        }
      }
    ...
    parserInput.restore = function (possibleErrorMessage) {
      if (
        ...
        (parserInput.i === furthest && possibleErrorMessage &&
          !furthestPossibleErrorMessage)
      ) {
    ...
    parserInput.isWhitespace = function (offset) {
      ...
      return (code === CHARCODE_SPACE || code === CHARCODE_CR ||
        code === CHARCODE_TAB || code === CHARCODE_LF);
    };
    ...
    parserInput.peekNotNumeric = function () {
      ...
      return (c > CHARCODE_9 || c < CHARCODE_PLUS) ||
        c === CHARCODE_FORWARD_SLASH || c === CHARCODE_COMMA;
    };
  ...
  var Parser = function Parser(context, imports, fileInfo) {
    ...
    function expect(arg, msg) {
      ...
      var result = (arg instanceof Function)
        ? arg.call(parsers)
        : parserInput.$re(arg);
      if (result) {
        return result;
    ...
    return {
      ...
      parse: function (str, callback, additionalData) {
        ...
        var ignored;
        var preText = "";
        globalVars = (additionalData && additionalData.globalVars)
        ...
        if (context.pluginManager) {
          ...
          for (var i = 0; i < preProcessors.length; i++) {
            str = preProcessors[i].process(
              str,
              { context: context, imports: imports, fileInfo: fileInfo },
            );
          }
        }
        if (globalVars || (additionalData && additionalData.banner)) {
          preText = ((additionalData && additionalData.banner)
      ...
      parsers: parsers = {
        ...
        primary: function () {
          ...
          while (true) {
            ...
            node = mixin.definition() || this.declaration() ||
              ...
              this.ruleset() || this.variableCall() || this.entities.call() ||
              this.atrule();
            if (node) {
              root.push(node);
            } else {
        ...
        entities: {
          ...
          arguments: function (prevArgs) {
            ...
            while (true) {
              if (prevArgs) {
                ...
                value = parsers.detachedRuleset() || this.assignment() ||
                  parsers.expression();
                if (!value) {
                  break;
                }
          ...
          variable: function () {
            ...
            if (
              ...
              if (
                ch === "(" || ch === "[" && !parserInput.prevChar().match(/^\s/)
              ) {
          ...
          args: function (isCall) {
            ...
            while (true) {
              if (isCall) {
                ...
                arg = entities.variable() || entities.property() ||
                  entities.literal() || entities.keyword() || this.call(true);
              }
              if (!arg || !hasSep) {
                break;
              }
        ...
        entity: function () {
          ...
          return this.comment() || entities.literal() || entities.variable() ||
            entities.url() ||
            entities.property() || entities.call() || entities.keyword() ||
        ...
        attribute: function () {
          ...
          op = parserInput.$re(/^[|~*$^]?=/);
          if (op) {
            val = entities.quoted() || parserInput.$re(/^[0-9]+%/) ||
              parserInput.$re(/^[\w-]+/) || entities.variableCurly();
          }
          expectChar("]");
        ...
        block: function () {
          var content;
          if (
            parserInput.$char("{") && (content = this.primary()) &&
            parserInput.$char("}")
          ) {
            return content;
          }
        ...
        conditions: function () {
          ...
          if (a) {
            while (true) {
              if (
                !parserInput.peek(/^,\s*(not\s*)?\(/) || !parserInput.$char(",")
              ) {
                break;
              }
        ...
        conditionAnd: function (needsParens) {
          ...
          function insideCondition() {
            var cond = self.negatedCondition(needsParens) ||
        ...
        atomicCondition: function (needsParens) {
          ...
          var op;
          function cond() {
            return this.addition() || entities.keyword() || entities.quoted() ||
              entities.mixinLookup();
          }
          cond = cond.bind(this);
          a = cond();
  ...
  var dataUri = (function (environment) {
    var fallback = function (functionThis, node) {
      return new URL(node, functionThis.index, functionThis.currentFileInfo)
  ...
  var minMax = function (isMin, args) {
    ...
    for (i = 0; i < args.length; i++) {
      ...
      currentUnified = current.unit.toString() === "" && unitClone !== undefined
        ? new Dimension(current.value, unitClone).unify()
        : current.unify();
      unit = currentUnified.unit.toString() === "" && unitStatic !== undefined
        ? unitStatic
      ...
      unitStatic = unit !== "" && unitStatic === undefined ||
        ...
        ? unit
        : unitStatic;
      unitClone = unit !== "" && unitClone === undefined
        ? current.unit.toString()
        : unitClone;
      j = values[""] !== undefined && unit !== "" && unit === unitStatic
        ? values[""]
        : values[unit];
      if (j === undefined) {
  ...
  var svg = (function (environment) {
    return {
      "svg-gradient": function (direction) {
        ...
        returner += "</" + gradientType + "Gradient><rect " +
          rectangleDimension + ' fill="url(#g)" /></svg>';
  ...
  var sourceMapOutput = (function (environment) {
    var SourceMapOutput = /** @class */ (function () {
      function SourceMapOutput(options) {
        ...
        this._sourceMapGeneratorConstructor = environment
          .getSourceMapGenerator();
        this._lineNumber = 0;
        this._column = 0;
      }
      SourceMapOutput.prototype.removeBasepath = function (path) {
        if (
          this._sourceMapBasepath && path.indexOf(this._sourceMapBasepath) === 0
        ) {
      ...
      ParseTree.prototype.toCSS = function (options) {
        ...
        if (options.pluginManager) {
          ...
          for (var i = 0; i < postProcessors.length; i++) {
            result.css = postProcessors[i].process(
              result.css,
              {
  ...
  var PluginManager = /** @class */ (function () {
    ...
    PluginManager.prototype.addPreProcessor = function (
      ...
      this.preProcessors.splice(
        indexToInsertAt,
        0,
        { preProcessor: preProcessor, priority: priority },
      );
    };
    /**
    ...
    PluginManager.prototype.addPostProcessor = function (
      ...
      this.postProcessors.splice(
        indexToInsertAt,
        0,
        { postProcessor: postProcessor, priority: priority },
      );
    };
    /**
         *
    ...
    var parse = function (input, options, callback) {
      ...
      if (!callback) {
        ...
        if (options.rootFileInfo) {
          ...
          if (
            rootFileInfo.rootpath && rootFileInfo.rootpath.slice(-1) !== "/"
          ) {
        ...
        if (options.useFileCache && fileCache[href]) {
          try {
            ...
            return reject(
              {
                filename: href,
                message: "Error loading file " + href + " error was " +
                  e.message,
              },
            );
          }
  ...
  var ErrorReporting = (function (window, less, options) {
    ...
    function errorConsole(e, rootHref) {
      ...
      var filename = e.filename || rootHref;
      var errors = [];
      var content = (e.type || "Syntax") + "Error: " +
        (e.message || "There is an error in your .less file") + " in " +
        filename;
      var errorline = function (e, i, classname) {
        if (e.extract[i] !== undefined) {
          errors.push(
  ...
  var Cache = (function (window, options, logger) {
    ...
    return {
      ...
      getCSS: function (path, webInfo, modifyVars) {
        ...
        if (
          timestamp && webInfo.lastModified &&
  ...
  var root = (function (window, options) {
    ...
    var cache = less.cache = options.cache ||
      Cache(window, options, less.logger);
    ...
    function loadStyleSheet(sheet, callback, reload, remaining, modifyVars) {
      ...
      function loadInitialFileCallback(loadedFile) {
        ...
        newFileInfo.rootpath = instanceOptions.rootpath ||
          newFileInfo.currentDirectory;
        if (webInfo) {
          ...
          loadStyleSheets(
            function (e, css, _, sheet, webInfo) {
              ...
              if (remainingSheets === 0) {
                ...
                less.logger.info(
                  "Less has finished. CSS generated in " + totalMilliseconds +
                    "ms",
                );
                resolve({
                  startTime: startTime,
  ...
  if (options$1.onReady) {
    ...
    less.registerStylesheetsImmediately();
    less.pageLoadFinished = less.refresh(less.env === "development").then(
      resolveOrReject,
      resolveOrReject,
    );
  }
