...
import { indexOf, copy } from 'https://deno.land/std@0.94.0/bytes/mod.ts'
...
import { basename, dirname, extname, join, resolve } from 'https://deno.land/std@0.94.0/path/mod.ts'
