...
import { dim, red, yellow } from 'https://deno.land/std@0.108.0/fmt/colors.ts'
import { createHash } from 'https://deno.land/std@0.108.0/hash/mod.ts'
import { dirname, basename, extname, join, relative } from 'https://deno.land/std@0.108.0/path/mod.ts'
