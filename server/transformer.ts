...
import { parseDeps, transform } from "https://deno.land/x/aleph_compiler@0.6.3/mod.ts";
import type { TransformOptions, TransformResult } from "https://deno.land/x/aleph_compiler@0.6.3/types.ts";
