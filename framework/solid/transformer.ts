import { transform } from "https://esm.sh/v112/@babel/standalone@7.21.3";
import babelPresetSolid from "https://esm.sh/v112/babel-preset-solid@1.6.12";
import solidRefresh from "https://esm.sh/v112/solid-refresh@0.5.2/babel";
...
export default class SolidTransformer implements ModuleLoader {
  ...
  load(specifier: string, content: string, env: ModuleLoaderEnv): ModuleLoaderOutput {
    console.log("transforming", specifier, content);
